    ...
    return (
        (<form
            ...
            <button
                disabled={!value}
                type="submit"
                className="absolute right-2 top-1/2 z-50 -translate-y-1/2 h-8 w-8 border border-gray-200 dark:border-zinc-800 flex items-center justify-center rounded-full transition duration-200 bg-gray-50 dark:bg-zinc-900 disabled:opacity-50 disabled:cursor-not-allowed">
                <motion.svg
                ...
                <AnimatePresence mode="wait">
                    {!value && (
                        <motion.p
                            ...
                            className="dark:text-zinc-500 text-zinc-500 text-sm sm:text-base font-normal pl-4 sm:pl-10 text-left w-[calc(100%-2rem)] truncate">
